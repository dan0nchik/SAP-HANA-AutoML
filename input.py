...
class Input:
    ...
    def __init__(self, X_train=None, y_train=None, target=None, file_path=None, url=None, config=None):
...
i = Input(target='y', file_path='bank.csv')
...
i_url = Input(target='Value', url='https://www.stats.govt.nz/assets/Uploads/Annual-enterprise-survey/Annual'
