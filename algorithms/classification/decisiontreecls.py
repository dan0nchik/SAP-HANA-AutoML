...
class DecisionTreeCls(BaseAlgorithm):
    ...
    def optunatune(self, trial):
        ...
        min_records_of_leaf = trial.suggest_int("DTC_min_records_of_leaf", 2, 100, log=True)
        min_records_of_parent = trial.suggest_int("DTC_min_records_of_parent", 2, 100, log=True)
        model = DecisionTreeClassifier(algorithm=algorithm, max_depth=max_depth, min_records_of_leaf=min_records_of_leaf,
